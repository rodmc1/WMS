...
function ReceivingAndReleasing(props) {
  ...
  const routes = [{ label: 'Receiving & Releasing', path: '/receiving-and-releasing' }];
  ...
  const handleRowClick = row => {
    history.push({
      pathname: `/receiving-and-releasing/${row.unique_code}`,
      data: row
    });
  }
...
export default connect(mapStateToProps, { fetchDeliveryNotices, fetchDeliveryNoticeByName })(ReceivingAndReleasing);